...
class Branch():
    def __init__(self, indexdb, blockstore, lasthash, firsthash=None):
        self.indexdb = indexdb
        self.blockstore = blockstore
        self.lasthash = lasthash
        self.firsthash = firsthash
        
        self.last = BlockRef(self.indexdb, self.blockstore, self.lasthash)
    ...
    def append(self, blockhash, blockindex):
        ...
        self.last = BlockRef(self.indexdb, self.blockstore, blockhash)
